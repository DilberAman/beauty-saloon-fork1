            ...
            <div className="topBar">
                <div className="container">
                    ...
                    <div style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: '15px' }}>
                        <span style={{ fontSize: '14px', opacity: 0.9 }}>Welcome, {user?.name}</span>
                        <button
                            onClick={logout}
                            style={{
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '60px', alignItems: 'start' }}>
                        ...
                        <div id="contact">
                            ...
                            <div style={{ marginTop: '30px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
                                ...
                                <p style={{ fontSize: '14px', color: 'hsl(var(--muted-foreground))', fontStyle: 'italic' }}>
                                    *Payments are cash only
                                </p>
                            </div>
                            <div style={{ marginTop: '20px' }}>
                                <a href="https://instagram.com" target="_blank" rel="noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', color: 'hsl(var(--foreground))', textDecoration: 'none', fontWeight: '500' }}>
                                    <svg
